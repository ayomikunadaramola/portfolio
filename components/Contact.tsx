...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    { icon: Github, label: 'GitHub', value: 'ayomikunadaramola', href: 'https://github.com/ayomikunadaramola' },
    { icon: MapPin, label: 'Location', value: 'Lagos, Nigeria', href: '#' },
  ]

  return (
    <section id="contact" className="py-24 lg:py-24 relative" ref={ref}
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold mb-4"
              ...
              Available for Senior Data Engineering, Cloud Data Platform, and Analytics Engineering
              <br /><span style={{ color: 'var(--accent)' }}>Opportunities.</span>
            </h2>
