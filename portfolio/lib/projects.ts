...
export const projects: Project[] = [
  ...
  {
    slug: 'water-sql-analysis',
    title: 'Integrated Water Management SQL Analysis',
    category: 'Data Analytics & SQL',
    shortDescription: 'Comprehensive SQL exploration of water management data uncovering operational inefficiencies and distribution challenges.',
    description: 'Performed a comprehensive SQL-based analysis of water management data using advanced techniques including joins, CTEs, window functions, and subqueries to generate actionable infrastructure insights.',
    problem: 'Water management systems contain fragmented and inconsistent data making it difficult to identify operational inefficiencies, assess water source performance, and support effective infrastructure decisions.',
    solution: 'Transformed raw environmental and operational data through deep SQL analysis — performing data cleaning, statistical profiling, water source classification, and multi-table exploration with advanced SQL to surface operational patterns.',
    impact: 'Improved reliability and usability of water management data, uncovered operational inefficiencies, and enabled data-driven decision-making for sustainable water resource planning and infrastructure improvement.',
    tools: ['SQL', 'MySQL', 'Statistics'],
    github: 'https://github.com/Stephen-delAyo/Sql_Projects/blob/main/Sqlprojects/Project%20part1.sql',
    featured: false,
    year: '2023',
    diagramType: 'analytics',
  },
  {
    slug: 'who-water-analysis-2020',
    title: 'WHO/UNICEF JMP Water Access Analysis',
    category: 'Data Analytics',
    shortDescription: 'Global household water access analysis using JMP 2020 dataset, benchmarking SDG 6 progress across countries.',
    description: 'Conducted an in-depth analysis of the WHO/UNICEF Joint Monitoring Program (JMP) 2020 dataset to evaluate global household access to drinking water services using service ladder methodologies.',
    problem: 'Governments and development organizations struggle to measure and compare access to clean drinking water across regions due to inconsistent reporting standards and large-scale, fragmented datasets.',
    solution: 'Built a structured analytical framework using Google Spreadsheets and visualization tools to benchmark water accessibility across countries, identify disparities, and track SDG 6 progress using JMP service ladder methodology.',
    impact: 'Generated data-driven insights into global water accessibility trends, highlighting disparities between countries and supporting evidence-based policymaking toward SDG 6 (Clean Water and Sanitation).',
    tools: ['Google Spreadsheet', 'Data Visualization', 'Statistics'],
    live: '#',
    featured: false,
    year: '2022',
    diagramType: 'water',
